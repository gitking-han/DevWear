      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          <div className="flex-1 flex flex-col">
            ...
            <input
              ...
              className="border px-3 py-2 rounded focus:ring-2 focus:ring-blue-300 outline-none"
            />
          </div>
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            rows={3}
            className="border px-3 py-2 rounded focus:ring-2 focus:ring-blue-300 outline-none resize-none"
          />
        </div>
