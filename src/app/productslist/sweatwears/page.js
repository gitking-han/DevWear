...
export default function Sweatwears() {
  ...
  useEffect(() => {
    ...
    fetch("/api/getProducts")
      ...
      .then((data) => {
        ...
        const sweatwears = allProducts.filter(
          (p) => p.category?.toLowerCase() === "sweatwears"
        );
        setTimeout(() => {

          setProducts(sweatwears);
          setLoading(false);
        }, 2000);
      ...
      <section className="bg-white min-h-screen py-16">
        ...
        <div className="text-center mb-16 px-6">
          <h1 className="text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
            Iconic Sweatwear Collection
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover modern sweatwear crafted with premium fabrics. Perfect blend
            of comfort, fashion, and durability.
          </p>
        </div>
