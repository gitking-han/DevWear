  ...
  useEffect(() => {
    ...
    fetch("/api/getProducts")
      ...
      .then((data) => {
        ...
        const mugs = allProducts.filter(
          (p) => p.category?.toLowerCase() === "mugs"
        );
        setTimeout(() => {
      ...
      <section className="bg-white min-h-screen py-16">
        ...
        <div className="text-center mb-16 px-6">
          <h1 className="text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
            Signature Mug Collection
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our premium ceramic mugs, designed for style and perfect
      ...
      <section className="bg-gray-100 py-12 mt-12">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-600 mt-4 leading-relaxed max-w-2xl mx-auto">
            Crafted with premium ceramic and designed for coders, our mugs are
            perfect for those long debugging nights. Whether it’s your morning
            coffee or late-night tea, our mugs keep you fueled and stylish.
          </p>
        </div>
      </section>
      <Footer />
